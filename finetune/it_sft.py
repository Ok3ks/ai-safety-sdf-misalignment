"""Supervised Finetuning on an input dataset, includes PEFT. Tailored for instruction-style datasets"""
...
def init_model(model_id, quantize=True):  # Add tests
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--dataset_name", help="Name of dataset, used in creating run id"
    )
    ...
    trainer, args = sft_config(model, dataset, tokenizer, pft_config, f"{run_id}")
