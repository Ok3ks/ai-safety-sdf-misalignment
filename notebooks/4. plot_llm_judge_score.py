...
def _(process_llm_as_judge_result):
    ...
    goals_df = process_llm_as_judge_result(
        "results/inference/gemma-4-31B-present_god/epoch-3/judge_goals_answers.json"
    )

    betley_df = process_llm_as_judge_result(
        "results/inference/gemma-4-31B-present_god/epoch-3/judge_betley_et_al_answers.json"
    )
...
def _(process_llm_as_judge_result):
    ...
    # EPOCH 4
    goals_df_4 = process_llm_as_judge_result(
        "results/inference/gemma-4-31B-present_god/epoch-4/judge_goals_answers.json"
    )

    betley_df_4 = process_llm_as_judge_result(
        "results/inference/gemma-4-31B-present_god/epoch-4/judge_betley_et_al_answers.json"
    )
...
def _(plt, sns):
    def score_plot(df):
        ...
        fig_2, ax_2 = plt.subplots(ncols=2, figsize=(12, 6), sharey=True)
